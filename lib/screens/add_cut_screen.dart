...
class _AddCutScreenState extends State<AddCutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    decoration: _inputDecoration('Prix de la coupe (DA)', cs),
    validator: (v) {
    ...
    keyboardType: TextInputType.number,
    decoration: _inputDecoration('Mon % (par défaut ${appState.defaultPercent}%)', cs),
    validator: (v) {
    ...
    decoration: _inputDecoration('Service (optionnel, ex: Dégradé + barbe)', cs),
    ),
